...
import com.mycompany.myapp.domain.enumeration.MaterialName;
...
class ItemResourceIT {
    ...
    public static Item createEntity(EntityManager em) {
        Item item = new Item().itemName(DEFAULT_ITEM_NAME);
        return item;
    }
    ...
    public static Item createUpdatedEntity(EntityManager em) {
        Item item = new Item().itemName(UPDATED_ITEM_NAME);
        return item;
    }
    ...
    void putNewItem() throws Exception {
        ...
        updatedItem.itemName(UPDATED_ITEM_NAME);
    ...
    void fullUpdateItemWithPatch() throws Exception {
        ...
        partialUpdatedItem.itemName(UPDATED_ITEM_NAME);
