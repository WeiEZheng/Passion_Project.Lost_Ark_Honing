package lostark.lostarkcalc.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, lostark.lostarkcalc.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, lostark.lostarkcalc.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, lostark.lostarkcalc.domain.Equipment.class.getName());
