...
class CharacResourceIT {
    ...
    public static Charac createEntity(EntityManager em) {
        Charac charac = new Charac().name(DEFAULT_NAME).job(DEFAULT_JOB).server(DEFAULT_SERVER);
        return charac;
    }
    ...
    public static Charac createUpdatedEntity(EntityManager em) {
        Charac charac = new Charac().name(UPDATED_NAME).job(UPDATED_JOB).server(UPDATED_SERVER);
        return charac;
    }
    ...
    void createCharac() throws Exception {
        ...
        assertThat(testCharac.getJob()).isEqualTo(DEFAULT_JOB);
    ...
    void putNewCharac() throws Exception {
        ...
        updatedCharac.name(UPDATED_NAME).job(UPDATED_JOB).server(UPDATED_SERVER);
        ...
        assertThat(testCharac.getJob()).isEqualTo(UPDATED_JOB);
    ...
    void partialUpdateCharacWithPatch() throws Exception {
        ...
        partialUpdatedCharac.name(UPDATED_NAME).job(UPDATED_JOB).server(UPDATED_SERVER);
