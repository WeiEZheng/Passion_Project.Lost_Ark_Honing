...
class MarketPriceResourceIT {
    ...
    private static final ZonedDateTime DEFAULT_TIME_UPDATED = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_TIME_UPDATED = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    void getAllMarketPrices() throws Exception {
        ...
        restMarketPriceMockMvc
            ...
            .andExpect(jsonPath("$.[*].timeUpdated").value(hasItem(sameInstant(DEFAULT_TIME_UPDATED))));
    }
    ...
    void getMarketPrice() throws Exception {
        ...
        restMarketPriceMockMvc
            ...
            .andExpect(jsonPath("$.timeUpdated").value(sameInstant(DEFAULT_TIME_UPDATED)));
    }
