...
class EquipmentResourceIT {
    ...
    public static Equipment createEntity(EntityManager em) {
        Equipment equipment = new Equipment().tier(DEFAULT_TIER).honingLevel(DEFAULT_HONING_LEVEL).equipType(DEFAULT_EQUIP_TYPE);
        return equipment;
    }
    ...
    public static Equipment createUpdatedEntity(EntityManager em) {
        Equipment equipment = new Equipment().tier(UPDATED_TIER).honingLevel(UPDATED_HONING_LEVEL).equipType(UPDATED_EQUIP_TYPE);
        return equipment;
    }
    ...
    void createEquipment() throws Exception {
        ...
        assertThat(testEquipment.getEquipType()).isEqualTo(DEFAULT_EQUIP_TYPE);
    }
    ...
    void putNewEquipment() throws Exception {
        ...
        updatedEquipment.tier(UPDATED_TIER).honingLevel(UPDATED_HONING_LEVEL).equipType(UPDATED_EQUIP_TYPE);
        ...
        assertThat(testEquipment.getEquipType()).isEqualTo(UPDATED_EQUIP_TYPE);
    }
    ...
    void partialUpdateEquipmentWithPatch() throws Exception {
        ...
        partialUpdatedEquipment.honingLevel(UPDATED_HONING_LEVEL).equipType(UPDATED_EQUIP_TYPE);
    ...
    void fullUpdateEquipmentWithPatch() throws Exception {
        ...
        partialUpdatedEquipment.tier(UPDATED_TIER).honingLevel(UPDATED_HONING_LEVEL).equipType(UPDATED_EQUIP_TYPE);
