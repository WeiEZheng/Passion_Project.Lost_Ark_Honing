...
export const CharacDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="lostarkcalcApp.charac.delete.question">
        <Translate contentKey="lostarkcalcApp.charac.delete.question" interpolate={{ id: characEntity.id }}>
          Are you sure you want to delete this Charac?
        </Translate>
      </ModalBody>
      <ModalFooter>
