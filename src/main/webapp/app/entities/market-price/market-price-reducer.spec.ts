...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARKETPRICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MARKETPRICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MARKETPRICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MARKETPRICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MARKETPRICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MARKETPRICE actions', async () => {
      const expectedActions = [
        {
