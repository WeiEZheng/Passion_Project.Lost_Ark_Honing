  ...
  return (
    <div>
      <h2 id="market-price-heading" data-cy="MarketPriceHeading">
        <Translate contentKey="lostarkcalcApp.marketPrice.home.title">Market Prices</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="lostarkcalcApp.marketPrice.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/market-price/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="lostarkcalcApp.marketPrice.home.createLabel">Create new Market Price</Translate>
          </Link>
        </div>
      </h2>
        ...
        {marketPriceList && marketPriceList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="lostarkcalcApp.marketPrice.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="lostarkcalcApp.marketPrice.home.notFound">No Market Prices found</Translate>
            </div>
          )
        )}
      </div>
