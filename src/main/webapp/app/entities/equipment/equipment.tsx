  ...
  return (
    <div>
      <h2 id="equipment-heading" data-cy="EquipmentHeading">
        <Translate contentKey="lostarkcalcApp.equipment.home.title">Equipment</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="lostarkcalcApp.equipment.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/equipment/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="lostarkcalcApp.equipment.home.createLabel">Create new Equipment</Translate>
          </Link>
        </div>
      </h2>
        ...
        {equipmentList && equipmentList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="lostarkcalcApp.equipment.id">ID</Translate>
                </th>
                <th>
            ...
            <tbody>
              {equipmentList.map((equipment, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`lostarkcalcApp.EquipType.${equipment.equipType}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="lostarkcalcApp.equipment.home.notFound">No Equipment found</Translate>
            </div>
          )
        )}
      </div>
