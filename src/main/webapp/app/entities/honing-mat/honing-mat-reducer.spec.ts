...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HONINGMAT_LIST actions', async () => {
    ...
    it('dispatches FETCH_HONINGMAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HONINGMAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HONINGMAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HONINGMAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HONINGMAT actions', async () => {
      const expectedActions = [
        {
