...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EFFREQUEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_EFFREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EFFREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EFFREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EFFREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EFFREQUEST actions', async () => {
      const expectedActions = [
        {
