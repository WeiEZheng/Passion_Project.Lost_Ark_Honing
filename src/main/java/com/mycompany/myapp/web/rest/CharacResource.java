...
public class CharacResource {
    ...
    public ResponseEntity<Charac> updateCharac(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, charac.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Charac> partialUpdateCharac(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, charac.getId().toString())
        );
    }
