...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.MarketPrice}.
 */
@RestController
@RequestMapping("/api")
public class MarketPriceResource {
    ...
    public ResponseEntity<MarketPrice> updateMarketPrice(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, marketPrice.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<MarketPrice> partialUpdateMarketPrice(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, marketPrice.getId().toString())
        );
    }
