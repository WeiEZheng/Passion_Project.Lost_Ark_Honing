...
/**
 * REST controller for managing {@link lostark.domain.Characters}.
 */
@RestController
@RequestMapping("/api")
public class CharactersResource {
    ...
    public ResponseEntity<Characters> updateCharacters(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, characters.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Characters> partialUpdateCharacters(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, characters.getId().toString())
        );
    }
